    ...
    <div>
      ...
      <section className="flex flex-col my-20 px-6 md:justify-self-center md:max-w-240">
        ...
        <div className="flex flex-col md:flex-row gap-6">
          <Link
            to={"/frontend"}
            className="flex flex-col border border-gray-100/20 p-4 gap-3.5 md:p-8 rounded-3xl hover:outline-2 hover:outline-purple-600 hover:-translate-y-1 hover:shadow-[0_0px_32px_4px] hover:shadow-purple-950 transition ease-linear"
          >
