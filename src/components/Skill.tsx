...
export function Skill() {
  return (
    <div className="flex flex-col mt-20 justify-self-center px-6">
      ...
      <div className="flex flex-wrap justify-center md:justify-start gap-2.5 max-w-150">
        <div className="flex flex-col bg-gray-800/50 w-26 p-3 rounded-lg border-2 border-gray-600 justify-center items-center">
